...
- Costs for optional services not yet available in Malaysia region (Inspector, Detective, Firewall Manager)
...
| AWS GuardDuty | Threat detection across 8 accounts in 2 regions (Cloudtrail Events: 16 million events/month, Vpc Flow Logs: 200 GB/month, Dns Logs: 50 GB/month) | $429.34 |
| AWS Security Hub | Security posture management for 8 accounts (Security Checks: 4,000 checks/month (500 per account), Finding Ingestion: 80,000 events/month, Automation Rules: 15 rules with 5 criteria) | $15.48 |
| AWS Config | Configuration tracking for all resources (Configuration Items: 8,000 items/month (1000 per account), Rule Evaluations: 40,000 evaluations/month) | $128.00 |
| AWS Network Firewall | Centralized firewall across 3 AZs with 5TB traffic (Endpoints: 3 endpoints (1 per AZ), Traffic: 5,000 GB/month) | $1,750.60 |
| AWS Transit Gateway | Central connectivity hub for VPCs (Attachments: 3 VPC attachments, Data Transfer: 500 GB/month) | $139.60 |
| VPC Endpoints | Interface endpoints for AWS services (S3, SSM, EC2, etc.) (Endpoints: 6 interface endpoints × 3 AZs, Data Transfer: 200 GB/month) | $141.60 |
| AWS KMS | Customer managed keys for encryption (Keys: 8 KMS keys (including replicas), Requests: 200,000 requests/month) | $9.08 |
| AWS Backup | Centralized backup management (Ebs Backups: 2,000 GB, Efs Backups: 800 GB, Cross Region Copies: 400 GB) | $176.00 |
| AWS CloudTrail | Organization-wide audit logging (Data Events: 20 million S3 events, Insights Events: 4 million events) | $36.00 |
...
| **Total** | **All services** | **$2,827.70/month** |
